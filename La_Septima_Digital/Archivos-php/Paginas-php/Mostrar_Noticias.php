...
<body>
    <nav>
        ...
        <div class="logo-container">
            <img src="./Iconos/La_Septima_Digital-removebg.png" alt="Logo del sitio" class="logo">
        </div>
        <div class="weather-time">
            <div class="weather" id="weather">Cargando clima...</div>
            <div class="time" id="time">Cargando hora...</div>
            <div class="live-container">
                <img src="./Iconos/mic.png" alt="Icon" class="live-image">
    ...
    <footer>
        <p>&copy; 2024 Mi Sitio de Noticias. Todos los derechos reservados.</p>
